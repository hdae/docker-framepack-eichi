...
oneframe_ichi: python oneframe_ichi.py --lang ${LANG:-ja} --port 7860 --server 0.0.0.0
demo_gradio_loop: python demo_gradio_loop.py --port 7860 --server 0.0.0.0
demo_gradio_video2loop: python demo_gradio_video2loop.py --port 7860 --server 0.0.0.0
